...
// Finish runs fns parallel, cancelled on any error.
...
func newGuardedWriter(ctx context.Context, channel chan<- interface{},
	done <-chan common.PlaceholderType) guardedWriter {
